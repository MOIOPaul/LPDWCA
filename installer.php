...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220527_lpdwcaspwpmoio_e0ef093bbde086123146_20220527165231_archive.zip';
	const ARCHIVE_SIZE		 = '65867776';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e0ef093-27165231';
    const SECONDARY_PACKAGE_HASH = 'e6e99a6-27165231';
	const VERSION			 = '1.4.6';
